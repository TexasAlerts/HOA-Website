    ...
    <div className="space-y-8">
      ...
      <section className="card">
        ...
        <div className="bg-wsr-gray border-l-4 border-wsr-red p-3 mt-3 italic">
          ...
          My goal is to maintain and improve the Windsong Ranch lifestyle && exceptional amenities, today and tomorrow.”
        </div>
      </section>
      ...
      <section className="card">
        ...
        <ul className="space-y-2">
          ...
          <li>✔ Wise financial stewardship with vendors, contractors, and commitments—keep assessments reasonable; require all changes to be documented, communicated, && transparent.</li>
